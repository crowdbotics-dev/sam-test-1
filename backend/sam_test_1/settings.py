"""
Django settings for sam_test_1 project.
...
WSGI_APPLICATION = 'sam_test_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_test_1 API",
    "DESCRIPTION": "API documentation for sam_test_1 App",
    "VERSION": "v1",
}
